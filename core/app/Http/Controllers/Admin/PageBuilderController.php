...
class PageBuilderController extends Controller
{
    ...
    public function managePagesSave(Request $request)
    {
        ...
        $request->validate([
            ...
            'slug' => 'required|min:3|string|max:255',
        ]);
        ...
        $page->save();
        $notify[] = ['success', 'New page a été ajouté avec succès'];
        return back()->withNotify($notify);
    }
    ...
    public function manageSection($id)
    {
        ...
        $pageTitle = 'Gestion Section of ' . $pdata->name;
    ...
    public function manageSectionUpdate($id, Request $request)
    {
        ...
        $page->save();
        $notify[] = ['success', 'Page sections a été mise à jour avec succès'];
        return back()->withNotify($notify);
    }
}
