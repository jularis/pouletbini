...
class NotificationController extends Controller
{
    ...
    {
        $request->validate([
            'email_from' => 'required|email|string|max:255',
            'sms_from' => 'required|string|max:255',
        ...
        $notify[] = ['success', 'Global notification settings a été mise à jour avec succès'];
    ...
    public function templateUpdate(Request $request, $id)
    {
        ...
        $notify[] = ['success', 'Notification template a été mise à jour avec succès'];
        return back()->withNotify($notify);
    }
    ...
    public function emailSettingUpdate(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', 'Email settings a été mise à jour avec succès'];
        return back()->withNotify($notify);
    }
    ...
    public function smsSettingUpdate(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', 'Sms settings a été mise à jour avec succès'];
        return back()->withNotify($notify);
    }
