                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                ...
                                                <label for="profilePicUpload1" class="bg--primary">@lang("Charger Image")</label>
                                                <small class="mt-2">@lang("Fichiers Autorisés"): <b>@lang('jpeg'), @lang('jpg'), @lang('png')</b>. @lang('Image will be resized into') {{getFileSize('seo')}}@lang('px'). </small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
