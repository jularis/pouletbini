...
@section('panel')
                                                    ...
                                                    <div class="image-upload">
                                                        <div class="thumb">
                                                            ...
                                                            <div class="avatar-edit">
                                                                ...
                                                                <small class="mt-2  ">@lang("Fichiers Autorisés"): <b>@lang('jpeg'), @lang('jpg'), @lang('png')</b>.
    ...
    @if(@$section->element)
        ...
        {{-- Ajouter METHOD MODAL --}}
        <div id="addModal" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"> @lang("Créer un nouveau") {{__(keyToTitle($key))}} @lang('Item')</h5>
        ...
        <div class="d-flex flex-wrap justify-content-end gap-2 align-items-center">
            @if($section->element->modal)
                <a href="javascript:void(0)" class="btn btn-sm btn-outline--primary addBtn"><i class="las la-plus"></i>@lang("Créer un nouveau")</a>
            @else
                <a href="{{route('admin.frontend.sections.element',$key)}}" class="btn btn-sm btn-outline--primary"><i class="las la-plus"></i>@lang("Créer un nouveau")</a>
            @endif
        </div>
        @endpush
    @endif
...
@push('style-lib')
<link href="{{ asset('assets/viseradmin/css/fontawesome-iconpicker.min.css') }}" rel="stylesheet">
@endpush

@push('script-lib')
    <script src="{{ asset('assets/viseradmin/js/fontawesome-iconpicker.js') }}"></script>
@endpush
