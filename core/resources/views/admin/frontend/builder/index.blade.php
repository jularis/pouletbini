                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <button type="submit"
                                            class="btn btn--primary w-100 h-45">@lang("Envoyer")</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            @if ($pdata->secs != null)
                                @foreach (json_decode($pdata->secs) as $sec)
                                    <li class="highlight icon-move item">
                                        ...
                                        <span class="d-inline-block text-white me-auto ms-2">
                                            {{ __(@$sections[$sec]['name']) }}</span>
                                    ...
                                    @if ($secs['builder'])
                                        <div class="float-end d-inline-block manage-content">
                                            <a href="{{ route('admin.frontend.sections', $k) }}" target="_blank"
                                                class="btn btn-outline-light text-center text-white cog-btn"
                                                title="@lang('Gestion Content')">
...
@push('script-lib')
    <script src="{{ asset('assets/viseradmin/js/jquery-sortable.js') }}"></script>
@endpush
