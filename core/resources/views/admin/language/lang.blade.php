                                            ...
                                            <div class="button--group">
                                                ...
                                                @if ($item->id != 1)
                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="@lang('Etes-vous sûr de vouloir supprimer cette langue de ce system?')"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="createModalLabel"> @lang('Ajouter Nouveau Language')</h4>
