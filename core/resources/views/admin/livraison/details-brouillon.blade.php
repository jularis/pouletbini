                            ...
                            <div class="table-responsive--md  table-responsive">
                                <table class="table table--light style--two">
                                    ...
                                    <tbody>
                                        ...
                                        $somme = 0;
                                        @endphp
                                        @foreach ($livraisonInfo->products->where('etat',0) as $livraisonProductInfo)
                                            <tr>
                                                ...
                                                <td>{{ showAmount($livraisonProductInfo->type_price*$livraisonProductInfo->qty) }} {{ $general->cur_sym }}</td>
                                            </tr>
                                            @php
                                        $somme = $somme + ($livraisonProductInfo->type_price*$livraisonProductInfo->qty);
                                        @endphp
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    <div class="card border--dark">
                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    @lang('Total')
                                    <span>{{ showAmount($somme+$livraisonInfo->paymentInfo->frais_livraison) }}
                                        {{ __($general->cur_text) }}</span>
                                </li>
...
@push('breadcrumb-plugins')
    <x-back route="{{ route('admin.livraison.brouillon') }}" />
@endpush
