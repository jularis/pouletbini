                            ...
                            <tbody> 
                                @forelse($livraisonInfos as $livraisonInfo)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.livraison.brouillon.edit', encrypt($livraisonInfo->id)) }}"
                                                class="btn btn-sm btn-outline--info"><i class="las la-edit"></i>
                                                @lang('Modifier')</a>
                                            <a href="{{ route('admin.livraison.brouillon.details', encrypt($livraisonInfo->id)) }}"
                                                class="btn btn-sm btn-outline--primary"><i class="las la-info-circle"></i>
                                                @lang('Details')</a>
                                            <a href="javascript::void();"
                                                data-action="{{ route('admin.livraison.delete', encrypt($livraisonInfo->id)) }}"
                                                data-question="@lang('Etre-vous sûr de vouloir supprimer cette commande en brouillon?')"
                                                class="btn btn-sm btn-outline--danger confirmationBtn"><i class="las la-trash"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
