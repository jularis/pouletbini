                                            ...
                                            <div class="button--group">
                                                ...
                                                @if ($extension->status == Status::DISABLE)
                                                    <button type="button"
                                                        ...
                                                        data-question="@lang('Etes-vous sûr de vouloir activer ce extension?')">
                                                ...
                                                @else
                                                    <button type="button"
                                                        ...
                                                        data-action="{{ route('admin.extensions.status', $extension->id) }}"
                                                        data-question="@lang('Etes-vous sûr de vouloir désactiver ce extension?')">
                ...
                <form method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn--primary w-100 h-45"
                            id="editBtn">@lang("Envoyer")</button>
                    </div>
                </form>
            </div>
        </div>
