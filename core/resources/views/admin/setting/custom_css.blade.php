...
@endpush
@push('style-lib')
    <link rel="stylesheet" href="{{asset('assets/viseradmin/css/codemirror.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/viseradmin/css/monokai.min.css')}}">
@endpush
@push('script-lib')
    <script src="{{asset('assets/viseradmin/js/codemirror.min.js')}}"></script>
    <script src="{{asset('assets/viseradmin/js/css.min.js')}}"></script>
    <script src="{{asset('assets/viseradmin/js/sublime.min.js')}}"></script>
@endpush
@push('script')
<script>
    "use strict";
