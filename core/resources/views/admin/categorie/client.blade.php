...
@section('panel')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-outline--primary  updateCategorie"
                                                ...
                                                data-email="{{ $client->email }}"><i
                                                    class="las la-pen"></i>@lang('Edit')</button>

                                            @if ($client->status == Status::DISABLE)
                                                <button type="button"
                                                    class="btn btn-sm btn-outline--success confirmationBtn"
                                                    data-action="{{ route('admin.livraison.categorie.client.status', $client->id) }}"
    ...
    <div id="categorieModel" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.livraison.categorie.client.store') }}" method="POST">
                    @csrf
    ...
    <div id="updateCategorieModel" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Update Livraison client')</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Fermer">
    ...
    <div id="typeModel" class="modal fade" tabindex="-1" role="dialog" style="z-index: 2147483647 !important;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.livraison.categorie.client.uploadcontent') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">   
