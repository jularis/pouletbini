                                ...
                                @forelse($logs as $log)
                                    <tr>
                                        <td>
                                            ...
                                            <span class="small d-block"> <a href="{{ route('admin.magasin.manager.edit',@$log->user->id) }}"><span>@</span>{{ @$log->user->username }}</a> </span>
                                            @else
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h3 class="text-center mb-3">@lang("A"): <span class="sent_to"></span></h3>
