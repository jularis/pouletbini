                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                ...
                                                <small class="mt-2  ">@lang("Fichiers Autorisés"): <b>@lang('jpeg'), @lang('jpg').</b> @lang('Image will be resized into 400x400px') </small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="d-flex flex-wrap justify-content-end gap-2 align-items-center">
    <a href="{{route('admin.password')}}" class="btn btn-sm btn-outline--primary"><i class="las la-key"></i>@lang("Paramètre Mot de Passe")</a>
</div>
@endpush
