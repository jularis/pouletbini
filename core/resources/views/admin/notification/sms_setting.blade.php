            ...
            <div class="card">
                <form action="" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4 d-none configForm" id="infobip">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang("Nom d'utilisateur")" name="infobip_username" value="{{ @$general->sms_config->infobip->username }}"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang("Mot de Passe") </label>
                                    <input type="text" class="form-control" placeholder="@lang("Mot de Passe")" name="infobip_password" value="{{ @$general->sms_config->infobip->password }}"/>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('API Key') </label>
                                    <input type="text" class="form-control" placeholder="@lang('API Key')" name="infobip_api_key" value="{{ @$general->sms_config->infobip->api_key }}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4 d-none configForm" id="smsBroadcast">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang("Nom d'utilisateur") </label>
                                    <input type="text" class="form-control" placeholder="@lang("Nom d'utilisateur")" name="sms_broadcast_username" value="{{ @$general->sms_config->sms_broadcast->username }}"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang("Mot de Passe") </label>
                                    <input type="text" class="form-control" placeholder="@lang("Mot de Passe")" name="sms_broadcast_password" value="{{ @$general->sms_config->sms_broadcast->password }}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4 d-none configForm" id="textMagic">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang("Nom d'utilisateur") </label>
                                    <input type="text" class="form-control" placeholder="@lang("Nom d'utilisateur")" name="text_magic_username" value="{{ @$general->sms_config->text_magic->username }}"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn w-100 h-45 btn--primary">@lang("Envoyer")</button>
                    </div>
                </form>
            </div><!-- card end -->
        </div>
