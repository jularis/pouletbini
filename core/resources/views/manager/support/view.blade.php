            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('ticket.reply', $myTicket->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="text-end">
                            <a href="javascript:void(0)" class="btn btn--primary btn-sm addFile"><i class="fa fa-plus"></i>
                                @lang("Créer un nouveau")</a>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn--primary w-100"> <i class="fa fa-reply"></i>
                            @lang('Reply')</button>
                    </form>
                </div>
            </div>
