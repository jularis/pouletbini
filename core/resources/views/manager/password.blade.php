...
@section('panel')
    ...
    <div class="row mb-none-30">
        ...
        <div class="col-lg-9 col-md-9 mb-30">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title mb-50 border-bottom pb-2">@lang("Changer Mot de Passe")</h5>
...
<div class="d-flex flex-wrap justify-content-end gap-2 align-items-center">
    <a href="{{route('manager.profile')}}" class="btn btn-sm btn-outline--primary" ><i class="las la-user"></i>@lang('Paramètre Profil')</a>
</div>
@endpush
