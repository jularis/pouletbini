            ...
            <div class="login-area">
                ...
                <form action="{{ route('manager.password.verify.code') }}" method="POST" class="login-form w-100">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <a href="{{ route('manager.password.request') }}" class="forget-text">@lang("Essayer d'envoyer encore")</a>
                    </div>
                    <button type="submit" class="btn cmn-btn w-100 mt-4">@lang("Envoyer")</button>
                </form>
                <a href="{{ route('manager.login') }}" class="text-white mt-4"><i class="las la-sign-in-alt"
