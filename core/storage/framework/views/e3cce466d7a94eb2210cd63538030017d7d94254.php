...
<div class="input-group w-auto flex-fill">
    <input type="search" name="search" class="form-control bg--white" placeholder="<?php echo e(__($placeholder)); ?>"
        value="<?php echo e(request()->search); ?>">
    <button class="btn <?php echo e($btn); ?>" type="submit"><i class="la la-search"></i></button>
</div>
<?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/components/search-key-field.blade.php ENDPATH**/ ?>