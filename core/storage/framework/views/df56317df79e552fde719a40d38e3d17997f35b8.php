                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                ...
                                                <label for="profilePicUpload1" class="bg--primary"><?php echo app('translator')->get("Charger Image"); ?></label>
                                                <small class="mt-2"><?php echo app('translator')->get("Fichiers Autorisés"); ?>: <b><?php echo app('translator')->get('jpeg'); ?>, <?php echo app('translator')->get('jpg'); ?>, <?php echo app('translator')->get('png'); ?></b>. <?php echo app('translator')->get('Image will be resized into'); ?> <?php echo e(getFileSize('seo')); ?><?php echo app('translator')->get('px'); ?>. </small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/admin/frontend/seo.blade.php ENDPATH**/ ?>