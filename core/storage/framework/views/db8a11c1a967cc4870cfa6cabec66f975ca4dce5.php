                                        ...
                                        <td>
                                            ...
                                            <?php if($client->status == Status::DISABLE): ?>
                                                <button type="button"
                                                    ...
                                                    data-action="<?php echo e(route('admin.livraison.categorie.client.status', $client->id)); ?>"
    ...
    <div id="typeModel" class="modal fade" tabindex="-1" role="dialog" style="z-index: 2147483647 !important;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.livraison.categorie.client.uploadcontent')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">   
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/admin/categorie/client.blade.php ENDPATH**/ ?>