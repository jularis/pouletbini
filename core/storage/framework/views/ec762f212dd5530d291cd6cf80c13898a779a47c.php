                                             ...
                                             <div class="col-md-4">
                                                    <select class="form-control selected_type" name="items[<?php echo e($loop->index); ?>][produit]" required>
                                                        ...
                                                        <?php $__currentLoopData = $produits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php if($produit->quantity==0): ?> disabled <?php endif; ?>
                                                             <?php if($item->produit->id==$produit->id): echo 'selected'; endif; ?>
                                                                data-categorie="<?php echo e($produit->categorie->name); ?>" data-price="<?php echo e(getAmount($produit->price)); ?>" data-quantity="<?php echo e($produit->quantity); ?>" >
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="discount"  class="form-control bg-white text-dark discount" value="<?php echo e(showAmount($livraisonInfo->payment->discount)); ?>">
                ...
                <div class="col-md-4">
                    <select class="form-control selected_type" name="items[${length}][produit]" required>
                        <option disabled selected value=""><?php echo app('translator')->get('Selectionner produit'); ?></option>
                            ...
                            <option value="<?php echo e($produit->id); ?>" 
                            <?php if($produit->quantity==0): ?> disabled <?php endif; ?>
                            data-categorie="<?php echo e($produit->categorie->name); ?>" data-price=<?php echo e(getAmount($produit->price)); ?> data-quantity="<?php echo e($produit->quantity); ?>"><?php echo e(__($produit->name)); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div> 
                <div class="col-md-4">
