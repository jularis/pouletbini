                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $livraisonInfos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $livraisonInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('manager.staff.edit', encrypt($livraisonInfo->senderStaff->id ?? null))); ?>"><span>@</span><?php echo e(__($livraisonInfo->senderStaff->username ?? null)); ?></a>
                                        </td>
...
<?php echo $__env->make('manager.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/manager/dashboard.blade.php ENDPATH**/ ?>