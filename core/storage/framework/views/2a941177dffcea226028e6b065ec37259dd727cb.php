                ...
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            <thead>
                            <tr>
                                <th><?php echo app('translator')->get('Gestion-Staff'); ?></th>
                                <th><?php echo app('translator')->get('Envoyé'); ?></th>
                                <th><?php echo app('translator')->get('Sender'); ?></th>
                                <th><?php echo app('translator')->get('Sujet'); ?></th>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            ...
                                            <?php if(@$log->user->user_type=='manager'): ?>
                                            <span class="small d-block"> <a href="<?php echo e(route('admin.magasin.manager.edit',@$log->user->id)); ?>"><span>@</span><?php echo e(@$log->user->username); ?></a> </span>
                                            <?php else: ?>
                                                <span class="small d-block"> <a href="<?php echo e(route('admin.staff.index')."?search=".@$log->user->username); ?>"><span>@</span><?php echo e(@$log->user->username); ?></a> </span>
                                            <?php endif; ?>
                                            <span class="d-block"><?php echo e(__(ucfirst(@$log->user->user_type))); ?></span>
                                            <?php else: ?>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Fermer"><i class="las la-times"></i></button>
      </div>
      <div class="modal-body">
        <h3 class="text-center mb-3"><?php echo app('translator')->get("A"); ?>: <span class="sent_to"></span></h3>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/admin/reports/notification_history.blade.php ENDPATH**/ ?>