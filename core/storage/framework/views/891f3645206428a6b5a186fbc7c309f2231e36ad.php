                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                ...
                                                <button type="button"
                                                    class="btn btn-sm btn-outline--dark ms-1 mb-2 helpBtn"
                                                ...
                                                <?php if($extension->status == Status::DISABLE): ?>
                                                    <button type="button"
                                                        ...
                                                        data-question="<?php echo app('translator')->get('Etes-vous sûr de vouloir activer ce extension?'); ?>">
                                                ...
                                                <?php else: ?>
                                                    <button type="button"
                                                        ...
                                                        data-action="<?php echo e(route('admin.extensions.status', $extension->id)); ?>"
                                                        data-question="<?php echo app('translator')->get('Etes-vous sûr de vouloir désactiver ce extension?'); ?>">
                ...
                <form method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn--primary w-100 h-45"
                            id="editBtn"><?php echo app('translator')->get("Envoyer"); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/admin/extension/index.blade.php ENDPATH**/ ?>