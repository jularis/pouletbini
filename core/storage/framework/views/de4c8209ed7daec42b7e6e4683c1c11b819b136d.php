    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card b-radius--10 ">
                <div class="card-body  p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    <th><?php echo app('translator')->get('Ferme'); ?></th>
                                    <th><?php echo app('translator')->get('Numero de Bande'); ?></th> 
                                    <th><?php echo app('translator')->get('Quantité'); ?></th>
                                    <th><?php echo app('translator')->get('Date arrivage'); ?></th>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $arrivages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arrivage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <span class="fw-bold"><?php echo e($arrivage->bande->ferme->nom); ?></span>
                                        </td>
                                        <td>
                                            <span class="fw-bold"><?php echo e($arrivage->bande->numero_bande); ?></span>
                                        </td>
                                        <td>
                                            <span class="fw-bold"><?php echo e($arrivage->total_poulet); ?></span>
                                        </td>     
                                        <td>
                                            <span class="d-block"><?php echo e(showDateTime($arrivage->date_arrivage)); ?></span>
                                            <span><?php echo e(diffForHumans($arrivage->date_arrivage)); ?></span>
                                        </td>
                                        <td> <?php echo $arrivage->statusBadge; ?> </td>
                                        <td>
                                            ...
                                            <div class="dropdown-menu p-0">
                                                <a href="<?php echo e(route('admin.arrivage.edit', $arrivage->id)); ?>"
                                                    class="dropdown-item"><i class="la la-pen"></i><?php echo app('translator')->get('Edit'); ?></a>
                                                <?php if($arrivage->status == Status::DISABLE): ?>
                                                    <button type="button" class="confirmationBtn  dropdown-item"
                                                        data-action="<?php echo e(route('admin.arrivage.status', $arrivage->id)); ?>"
                ...
                <?php if($arrivages->hasPages()): ?>
                    <div class="card-footer py-4">
                        <?php echo e(paginateLinks($arrivages)); ?>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <a href="<?php echo e(route('admin.arrivage.create')); ?>" class="btn  btn-outline--primary h-45 addNewCooperative">
        <i class="las la-plus"></i><?php echo app('translator')->get('Ajouter un arrivage'); ?>
    </a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pouletbini\core\resources\views/admin/arrivage/index.blade.php ENDPATH**/ ?>