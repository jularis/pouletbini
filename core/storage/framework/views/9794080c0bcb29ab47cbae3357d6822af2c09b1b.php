                    ...
                    <div class="login-area">
                        <div class="login-wrapper">
                            <div class="login-wrapper__top">
                                ...
                                <p class="text-white"><?php echo e(__($pageTitle)); ?> 
                                    <?php echo app('translator')->get('Tableau de Bord'); ?></p>
                            </div>
                            <div class="login-wrapper__body">
                                <form action="<?php echo e(route('manager.login')); ?>" method="POST"
...
<?php endif; ?> -->
                                    <div class="d-flex flex-wrap justify-content-between">
                                        ...
                                        <a href="<?php echo e(route('manager.password.request')); ?>"
...
<?php echo $__env->make('manager.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/manager/auth/login.blade.php ENDPATH**/ ?>