                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $livraisonLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $livraisonInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                            <?php echo e($livraisonInfo->receiverClient->address ?? "Aucune"); ?>
...
<?php echo $__env->make('manager.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/manager/livraison/commandeQueue.blade.php ENDPATH**/ ?>