...
<a href="<?php echo e($route); ?>" class="btn btn-sm btn-outline--primary">
    <i class="la la-undo"></i> <?php echo app('translator')->get('Retour'); ?>
</a>
<?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/components/back.blade.php ENDPATH**/ ?>