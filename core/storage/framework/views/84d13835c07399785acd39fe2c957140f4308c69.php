<?php $__env->startSection('panel'); ?>
                                                    ...
                                                    <div class="image-upload">
                                                        <div class="thumb">
                                                            ...
                                                            <div class="avatar-edit">
                                                                ...
                                                                <small class="mt-2  "><?php echo app('translator')->get("Fichiers Autorisés"); ?>: <b><?php echo app('translator')->get('jpeg'); ?>, <?php echo app('translator')->get('jpg'); ?>, <?php echo app('translator')->get('png'); ?></b>.
    ...
    <?php if(@$section->element): ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"> <?php echo app('translator')->get("Créer un nouveau"); ?> <?php echo e(__(keyToTitle($key))); ?> <?php echo app('translator')->get('Item'); ?></h5>
        ...
        <div class="d-flex flex-wrap justify-content-end gap-2 align-items-center">
            <?php if($section->element->modal): ?>
                <a href="javascript:void(0)" class="btn btn-sm btn-outline--primary addBtn"><i class="las la-plus"></i><?php echo app('translator')->get("Créer un nouveau"); ?></a>
            <?php else: ?>
                <a href="<?php echo e(route('admin.frontend.sections.element',$key)); ?>" class="btn btn-sm btn-outline--primary"><i class="las la-plus"></i><?php echo app('translator')->get("Créer un nouveau"); ?></a>
            <?php endif; ?>
        </div>
        <?php $__env->stopPush(); ?>
    <?php endif; ?>
...
<link href="<?php echo e(asset('assets/viseradmin/css/fontawesome-iconpicker.min.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('script-lib'); ?>
    <script src="<?php echo e(asset('assets/viseradmin/js/fontawesome-iconpicker.js')); ?>"></script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/admin/frontend/index.blade.php ENDPATH**/ ?>