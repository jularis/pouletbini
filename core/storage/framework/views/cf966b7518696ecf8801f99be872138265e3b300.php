...
<?php endif; ?> -->
                                    <div class="d-flex flex-wrap justify-content-between">
                                        <div class="form-check me-3">
                                            ...
                                            <label class="form-check-label"><?php echo app('translator')->get('Se souvenir de moi'); ?></label>
                                        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>