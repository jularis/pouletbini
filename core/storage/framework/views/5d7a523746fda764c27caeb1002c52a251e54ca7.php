                        ...
                        <div class="d-flex flex-wrap gap-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <select name="status" class="form-control">
                                    <option value=""><?php echo app('translator')->get("Tous"); ?></option> 
                                    <option value="2" <?php echo e(request()->status == 2 ? 'selected' : ''); ?>><?php echo app('translator')->get('En attente'); ?></option>
                                    <option value="3" <?php echo e(request()->status == 3 ? 'selected' : ''); ?>><?php echo app('translator')->get('Livré'); ?></option>
                                </select>
                            </div>
                            <div class="flex-grow-1">
                            ...
                            <tbody> 
                                <?php $__empty_1 = true; $__currentLoopData = $livraisonLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $livraisonInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span><?php echo e(__($livraisonInfo->info->senderMagasin->name)); ?></span><br>
                                            <?php echo e(__($livraisonInfo->info->senderStaff->fullname)); ?>

                                        </td>

                                        <td>
                                        <span class="fw-bold">
                                            <?php echo e(__($livraisonInfo->info->receiverClient->address)); ?>

                                            </span>
                                            <br>
                                            <?php if($livraisonInfo->info->receiver_client_id): ?>
                                                <?php echo e(__($livraisonInfo->info->receiverClient->name)); ?>

                                                <?php echo e(__($livraisonInfo->info->receiverClient->phone)); ?>
                                        ...
                                        <td>
                                            <span class="fw-bold d-block">
                                                <?php echo e(showAmount(@$livraisonInfo->final_amount-@$livraisonInfo->partial_amount)); ?>

                                                <?php echo e(__($general->cur_text)); ?>

                                            </span>
                                            <span><?php echo e($livraisonInfo->info->code); ?></span>
                                        </td>
                                        <td>
                                            <?php echo e(showDateTime($livraisonInfo->info->created_at, 'd M Y')); ?>

                                        </td>
                                        <td>
                                            <?php echo e(showDateTime($livraisonInfo->info->estimate_date, 'd M Y')); ?>

                                        </td>
                                        <td> 
                                            <?php if($livraisonInfo->status == Status::PAID): ?>
                                                <span class="badge badge--success"><?php echo app('translator')->get('Payé'); ?></span>
                                            <?php elseif($livraisonInfo->status == Status::PARTIAL): ?>
                                        ...
                                        <td>
                                                ...
                                                <button type="button" class="btn btn-outline--success m-1 payment"
                                                    data-code="<?php echo e($livraisonInfo->info->code); ?>" data-finalamount="<?php echo e($livraisonInfo->final_amount); ?>" data-partialamount="<?php echo e($livraisonInfo->partial_amount); ?>">
                                                    <i class="fa fa-credit-card"></i> <?php echo app('translator')->get("Effectuer le Paiement"); ?>
                                                </button> 
                                            <a href="<?php echo e(route('manager.livraison.invoice', encrypt($livraisonInfo->livraison_info_id))); ?>"
                                                title="" class="btn btn-sm btn-outline--info"><i
                                                    class="las la-file-invoice"></i> <?php echo app('translator')->get('Facture'); ?></a>
                                            <a href="<?php echo e(route('manager.livraison.details', encrypt($livraisonInfo->livraison_info_id))); ?>"
...
<?php echo $__env->make('manager.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/manager/livraison/credit.blade.php ENDPATH**/ ?>