    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card b-radius--10 ">
                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->get('Numero bande'); ?></th> 
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $bandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <span class="fw-bold"><?php echo e($bande->ferme->nom); ?></span>
                                        </td>
                                        <td>
                                            <span class="fw-bold"><?php echo e($bande->numero_bande); ?></span>
                                        </td>     
                                        <td>
                                            <span class="d-block"><?php echo e(showDateTime($bande->created_at)); ?></span>
                                            <span><?php echo e(diffForHumans($bande->created_at)); ?></span>
                                        </td>
                                        <td> <?php echo $bande->statusBadge; ?> </td>
                                        <td>
                                            ...
                                            <div class="dropdown-menu p-0">
                                                <a href="<?php echo e(route('admin.bande.edit', $bande->id)); ?>"
                                                    class="dropdown-item"><i class="la la-pen"></i><?php echo app('translator')->get('Edit'); ?></a>
                                                <?php if($bande->status == Status::DISABLE): ?>
                                                    <button type="button" class="confirmationBtn  dropdown-item"
                                                        data-action="<?php echo e(route('admin.bande.status', $bande->id)); ?>"
                ...
                <?php if($bandes->hasPages()): ?>
                    <div class="card-footer py-4">
                        <?php echo e(paginateLinks($bandes)); ?>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <a href="<?php echo e(route('admin.bande.create')); ?>" class="btn  btn-outline--primary h-45 addNewCooperative">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pouletbini\core\resources\views/admin/bande/index.blade.php ENDPATH**/ ?>