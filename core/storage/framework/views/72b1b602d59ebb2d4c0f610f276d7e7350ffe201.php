                ...
                <button type="button" class="" data-bs-toggle="dropdown" data-display="static" aria-haspopup="true"
                    ...
                    <span class="navbar-user">
                        <span class="navbar-user__thumb"><img
                                src="<?php echo e(getImage('assets/viseradmin/images/profile/'. auth()->guard('admin')->user()->image)); ?>"
                                alt="image"></span>
...
<!-- navbar-wrapper end -->
<?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/admin/partials/topnav.blade.php ENDPATH**/ ?>