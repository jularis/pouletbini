    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="<?php echo e(menuActive(['manager.livraison*','manager.livraison.delivery.queue','manager.livraison.commande.queue','manager.livraison.manage.delivered','manager.livraison.manage.credit','manager.livraison.manage.list'], 3)); ?>">
                        <i class="menu-icon las la-university"></i>
                        <span class="menu-title"><?php echo app('translator')->get('Gestion Commandes'); ?> </span>
                    </a>
                    <div class="sidebar-submenu <?php echo e(menuActive(['manager.livraison*','manager.livraison.delivery.queue','manager.livraison.commande.queue','manager.livraison.manage.delivered','manager.livraison.manage.credit','manager.livraison.manage.list'], 2)); ?> ">
                        <ul>
                    ...
                    <a href="<?php echo e(route('manager.livraison.create')); ?>" class="nav-link ">
                        ...
                        <span class="menu-title"><?php echo app('translator')->get('Enregistrement Commande'); ?></span>
                            ...
                            <li class="sidebar-menu-item active <?php echo e(menuActive('manager.livraison.commande.queue')); ?>">
                                <a href="<?php echo e(route('manager.livraison.commande.queue')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get("Commandes En attente"); ?></span>
                                </a>
                            </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/manager/partials/sidenav.blade.php ENDPATH**/ ?>