    ...
    (function () {
        ...
        if ("serviceWorker" in navigator) {
            window.addEventListener("load", function () {
                navigator.serviceWorker.register("<?php echo e(url('/sw.js')); ?>", { scope: "<?php echo e(url('/')); ?>/" }).catch(function () {});
            });
        }
...
<?php /**PATH C:\laragon\www\pouletbini\core\resources\views/partials/pwa.blade.php ENDPATH**/ ?>