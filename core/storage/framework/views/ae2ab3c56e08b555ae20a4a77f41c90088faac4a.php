...
<a href="<?php echo e(route('manager.livraison.delivery.queue.export.excel')); ?>?<?php echo e(http_build_query(request()->all())); ?>" class="btn btn-outline--warning ms-2"><i class="las la-cloud-download-alt"></i> Exporter Excel</a>
<?php $__env->stopPush(); ?>
