                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="cur_text" required
                                        value="<?php echo e(__($general->cur_text)); ?>">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group ">
...
<?php $__env->startPush('script-lib'); ?>
    <script src="<?php echo e(asset('assets/viseradmin/js/spectrum.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php $__env->startPush('style-lib'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/viseradmin/css/spectrum.css')); ?>">
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/poulnymi/new.pouletbini.com/core/resources/views/admin/setting/general.blade.php ENDPATH**/ ?>